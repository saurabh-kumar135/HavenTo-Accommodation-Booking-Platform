...
echo "=== STEP 1: Re-bind Metro Port 8081 ==="
...
echo ""
echo "=== STEP 3: Send Intent to Device ==="
...
adb shell screencap -p /sdcard/havento_app_deployed_check.png
adb pull /sdcard/havento_app_deployed_check.png ./havento_app_deployed_check.png
cp ./havento_app_deployed_check.png /home/saurabh-kumar123/.gemini/antigravity/brain/ada8a314-a35c-41ca-b59b-3b77b8b3ab06/havento_app_deployed_check.png
echo "Screenshot saved to HavenToApp/havento_app_deployed_check.png"
